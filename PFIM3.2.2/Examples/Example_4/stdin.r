...
condinit<-expression(c(0,Rin/kout))
...
parameters<-c("V","Vm","km","Rin","kout","C50")


#Fixed effects parameters values
#--------------------------------
beta<-c(12,0.1,0.5,6.4,1.2,1)
...
omega<-diag(c(0.25,0.25,0,0.3,0.25,0))
...
protA<-list(c(0.5, 1, 2, 19, 38, 61, 160)) 
protB<-list(c(0, 0.7, 1.5, 23, 12, 44, 144)) 
...
#Vector of Names on Y axes for each response
#---------------------------------
names.datay<-c("Concentration","Effect")

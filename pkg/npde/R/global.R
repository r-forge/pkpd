...
set.npde.plotoptions <- function(object, ...) UseMethod("set.npde.plotoptions")
setGeneric(name="set.npde.plotoptions", def=function(object,...){standardGeneric("set.npde.plotoptions")})

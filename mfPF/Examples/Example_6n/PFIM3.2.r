#PFIM 3.2 Multiple responses
#January 2010
#Copyright © PFIM 3.2 – Caroline Bazzoli, Sylvie Retout, Emmanuelle Comets, France Mentré - Université Paris Diderot – INSERM.
#-----------------------------------------------------------------------------------
...
directory<-"C:\\Documents and Settings\\Caroline Bazzoli\\Mes documents\\caroline\\PFIM3.2versionfinale\\Examples\\Example_6"
directory.program<-"C:\\Documents and Settings\\Caroline Bazzoli\\Mes documents\\caroline\\PFIM3.2versionfinale\\PFIM3.2\\Program"

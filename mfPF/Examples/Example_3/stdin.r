...
parameters<-c("V","Vm","km","Alin")


#Fixed effects parameters values
#--------------------------------
beta<-c(12.2,0.082,0.37,0.1)
...
#-----------------------------------------------------------------
protA<-list(c(0.5, 2, 30, 49, 180)) 
protB<-list(c(0.5, 2, 14, 110, 150)) 
...
#--------------------------------------------------------------------
sampwinA<-list(c(0.5, 2, 10, 30, 49, 158, 180))
sampwinB<-list(c(0.5, 2, 14, 50, 80, 110, 150))
...
#Vector of Names on Y axes for each response
#---------------------------------
names.datay<-c("Concentration","Effet")

...
protA<-list(c(10/60/24,1/24,6/24,0.5, 2, 4, 7, 14, 21, 35, 49, 63, 77, 91)) 
protB<-list(c(10/60/24, 7, 35, 77, 91)) 
protC<-list(c(0.5, 2, 4, 7, 14, 21, 35, 49, 63, 77, 91)) 

parameters<-c("Kd","CLD","CLT","RateT","V")
#beta<-c(0.2,0.2,1,40,6)
beta<-c(0.2,0.2,1,40,6)

condinit<-expression(c(5*70/0.15, RateT/CLT*V))
...
#------------------------------------------------------------------------
y.rangeA<-c(1e-7,1e2) # NULL = default range
